...
public class Monster2 extends Monster { // 이름 가명칭-이름을 제대로 지어줍시다! 몬스터1이라니! 어떻게 알아먹나요!

	private Component bullet;



	public Monster2(Point xy,StoryRoom room) {
		super(xy,room);
		setImage("monster2.gif");
		speed = 0.04f; // 이건 좀 애매한데  속도라..
		colliderSpeed=speed;
